...
Purpose: internal quality review of the generated SAP IS-U Assistant IP Box documentation package before advisor use.

This review does not provide tax advice and does not determine eligibility, qualifying profit, nexus fraction, attribution percentage or filing treatment.

## Review Findings

| Check | Result | Corrections Applied |
| --- | --- | --- |
| Unsupported or overly strong statements | Minor tightening required | Reframed the tool as company-developed software subject to ownership/advisor review where needed. Added stronger caveats around percentages and real evidence. |
| SAP/OpenAI/Qdrant/client ownership boundary | Passed with improvements | Existing documents already excluded SAP, OpenAI, Qdrant and client data from owned IP. The third-party boundary wording was tightened for OpenAI. |
...
## Required Evidence Before Advisor Reliance

- Corporate ownership and authorship records.
- Git history and release evidence reconciled to actual commits.
- Screenshots generated from the actual tool, not staged evidence.
- Monthly usage logs generated during real client delivery.
- Ticket references linked to usage IDs.
- Output-used and human-reviewed confirmation.
- Timesheets or work logs showing total productive SAP IS-U hours.
- Invoice/revenue mapping by client and service line.
- Anonymized incident examples and evidence hashes.
- Advisor-reviewed attribution methodology.

## Corrections Summary

- Added this critical review document.
- Updated position paper language around ownership, 100% maximum and 60% target scenario.
