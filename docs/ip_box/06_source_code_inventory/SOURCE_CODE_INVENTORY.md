...
| Chat | `src/assistant/chat/chat_service.py` | Answer generation | AI orchestration | High | Source/tests | Implemented |
...
| IP Evidence | `src/web/routers/ipbox.py` | Usage evidence review APIs | Monthly review workflow | High | Source/tests | Implemented |
| IP Evidence | `src/web/templates/ipbox_usage.html` | Usage evidence review UI | Advisor evidence workflow | High | Source/tests | Implemented |
