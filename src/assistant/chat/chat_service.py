...
class ChatService:
    ...
    5. Call OpenAI for ancliar (gpt-5.2, reasoning effort high/xhigh)
    """
    ...
    def ancliar(
        ...
        """
        Ancliar a question using RAG per PLAN.md section 10.
        ...
        Returns:
            ChatResult with ancliar and source KB items
        """
...
class ChatResult:
    ...
    def __init__(self, ancliar: str, sources: list[KBItem]):
