...
Shows chat input, ancliar output, and source traceability.
"""
import json
import logging
...
class ChatTab:
    ...
    def _on_send(self, _event=None):
        ...
        Thread(target=self._do_ancliar, args=(question,), daemon=True).start()

    def _do_ancliar(self, question: str):
        try:
            ...
            self._append_history(f"Assistant: {result.ancliar}\n\n")
